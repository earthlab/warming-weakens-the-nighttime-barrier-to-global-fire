...
lc_area <- 
  ...
  dplyr::filter(koppen_orig_modis_name != "Cold Croplands",
                koppen_orig_modis_name != "Temperate Croplands",
                koppen_orig_modis_name != "Tropical Croplands",
                koppen_orig_modis_name != "Arid Croplands")
...
# excluding croplands and cropland/natural veg mosaics here
afd <- afd[str_sub(lc,2,3) != "12",]
afd <- afd[str_sub(lc,2,3) != "14",]
...
afd_global_summary_no_trend <-
  ...
  dplyr::summarize(mean_prop = mean(prop_n_per_op_night),
...
write.csv(afd_global_summary, "data/out/mcd14ml-global-trend-by-month_croplands-excluded.csv")
system2(command = "aws", args = "s3 cp data/out/mcd14ml-global-trend-by-month_croplands-excluded.csv s3://earthlab-mkoontz/warming-weakens-the-nighttime-barrier-to-global-fire/data/out/mcd14ml-global-trend-by-month_croplands-excluded.csv")

write.csv(afd_global_summary_wide, "data/out/mcd14ml-global-trend-by-month_wide_croplands-excluded.csv")
system2(command = "aws", args = "s3 cp data/out/mcd14ml-global-trend-by-month_wide_croplands-excluded.csv s3://earthlab-mkoontz/warming-weakens-the-nighttime-barrier-to-global-fire/data/out/mcd14ml-global-trend-by-month_wide_croplands-excluded.csv")

write.csv(afd_global_summary_by_year, "data/out/mcd14ml-global-trend-by-year_croplands-excluded.csv")
system2(command = "aws", args = "s3 cp data/out/mcd14ml-global-trend-by-year_croplands-excluded.csv s3://earthlab-mkoontz/warming-weakens-the-nighttime-barrier-to-global-fire/data/out/mcd14ml-global-trend-by-year_croplands-excluded.csv")

write.csv(afd_global_summary_by_year_wide, "data/out/mcd14ml-global-trend-by-year_wide_croplands-excluded.csv")
system2(command = "aws", args = "s3 cp data/out/mcd14ml-global-trend-by-year_wide_croplands-excluded.csv s3://earthlab-mkoontz/warming-weakens-the-nighttime-barrier-to-global-fire/data/out/mcd14ml-global-trend-by-year_wide_croplands-excluded.csv")

write.csv(afd_koppen_summary, "data/out/mcd14ml-trend-by-month-koppen_croplands-excluded.csv")
system2(command = "aws", args = "s3 cp data/out/mcd14ml-trend-by-month-koppen_croplands-excluded.csv s3://earthlab-mkoontz/warming-weakens-the-nighttime-barrier-to-global-fire/data/out/mcd14ml-trend-by-month-koppen_croplands-excluded.csv")

write.csv(afd_koppen_summary_wide, "data/out/mcd14ml-trend-by-month-koppen_wide_croplands-excluded.csv")
system2(command = "aws", args = "s3 cp data/out/mcd14ml-trend-by-month-koppen_wide_croplands-excluded.csv s3://earthlab-mkoontz/warming-weakens-the-nighttime-barrier-to-global-fire/data/out/mcd14ml-trend-by-month-koppen_wide_croplands-excluded.csv")

write.csv(afd_summary, "data/out/mcd14ml-trend-by-month-landcover_croplands-excluded.csv")
system2(command = "aws", args = "s3 cp data/out/mcd14ml-trend-by-month-landcover_croplands-excluded.csv s3://earthlab-mkoontz/warming-weakens-the-nighttime-barrier-to-global-fire/data/out/mcd14ml-trend-by-month-landcover_croplands-excluded.csv")

write.csv(afd_landcover_summary_wide, "data/out/mcd14ml-trend-by-month-landcover_wide_croplands-excluded.csv")
system2(command = "aws", args = "s3 cp data/out/mcd14ml-trend-by-month-landcover_wide_croplands-excluded.csv s3://earthlab-mkoontz/warming-weakens-the-nighttime-barrier-to-global-fire/data/out/mcd14ml-trend-by-month-landcover_wide_croplands-excluded.csv")
...
ggsave(filename = "figs/mcd14ml_n-trend_global_croplands-excluded.png", plot = global_n_gg)
...
ggsave(filename = "figs/mcd14ml_frp-trend_global_croplands-excluded.png", plot = global_frp_gg)
...
ggsave(filename = "figs/mcd14ml_prop-n-trend_global_croplands-excluded.png", plot = global_prop_n_gg)
...
ggsave(filename = "figs/mcd14ml_prop-n-trend_global_monthly_croplands-excluded.png", plot = global_prop_n_gg)

# koppen 1 Tropical
tropical_n_gg <-
  ggplot(dplyr::filter(afd_summary, koppen == 1), 
         aes(x = year_month, y = n_per_op_per_Mkm2, color = dn_detect)) +
  geom_line() + 
  scale_color_manual(values = c("#b2182b", "#2166ac")) +
  facet_wrap(~koppen_orig_modis_name, scales = "free") +
  geom_smooth() +
  theme_bw() +
  labs(x = "Date (monthly increments)",
       y = "Number of detections per overpass per million square km",
...
ggsave(filename = "figs/mcd14ml_n-trend_tropical_croplands-excluded.png", plot = tropical_n_gg)
ggsave(filename = "figs/mcd14ml_n-trend_arid_croplands-excluded.png", plot = arid_n_gg)
ggsave(filename = "figs/mcd14ml_n-trend_temperate_croplands-excluded.png", plot = temperate_n_gg)
ggsave(filename = "figs/mcd14ml_n-trend_cold_croplands-excluded.png", plot = cold_n_gg)
...
ggsave(filename = "figs/mcd14ml_frp-trend_tropical_croplands-excluded.png", plot = tropical_frp_gg)
ggsave(filename = "figs/mcd14ml_frp-trend_arid_croplands-excluded.png", plot = arid_frp_gg)
ggsave(filename = "figs/mcd14ml_frp-trend_temperate_croplands-excluded.png", plot = temperate_frp_gg)
ggsave(filename = "figs/mcd14ml_frp-trend_cold_croplands-excluded.png", plot = cold_frp_gg)
